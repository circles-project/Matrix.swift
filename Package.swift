...
//        .package(url: "https://gitlab.futo.org/circles/MatrixSDKCrypto.git", exact: "0.3.12.3"),
        .package(url: "https://gitlab.futo.org/circles/MatrixSDKCrypto.git", branch: "michael/msc3061"),
