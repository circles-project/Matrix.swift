...
extension Matrix {
    public struct Credentials: Codable {
        ...
        public func save(defaults: UserDefaults = UserDefaults.standard) throws {
        ...
        public static func load(for userId: UserId, defaults: UserDefaults = UserDefaults.standard) throws -> Credentials? {
